 ...
 * Run this to initialize all 5 dynamic pages, their sections, and repeatable blocks.
 */
...
try {
    ...
    // 1. Import schema from database/database.sql (which now drops tables first)
    ...
    Block::setVal($secSvGridId, 'svc_points', 'textarea', "Réseaux sécurisés | Sécurité accrue | Extension d'infrastructures", 3, 3);
    // Card 4
    ...
    Block::setVal($secSvGridId, 'svc_points', 'textarea', "Montage pro vertical/horizontal | Contenus viraux | Croissance d'audience", 4, 3);
    // Card 5
    Block::setVal($secSvGridId, 'svc_title', 'text', 'Créateur de Contenu Digital', 5, 0);
    Block::setVal($secSvGridId, 'svc_tag', 'text', 'Contenu', 5, 1);
    Block::setVal($secSvGridId, 'svc_icon', 'text', 'edit-3', 5, 2);
    Block::setVal($secSvGridId, 'svc_points', 'textarea', "Stratégies SEO | Campagnes pub multicanales | Contenus IA-assistés", 5, 3);
    // Card 6
    Block::setVal($secSvGridId, 'svc_title', 'text', 'Intelligence Artificielle & Stratégie', 6, 0);
    Block::setVal($secSvGridId, 'svc_tag', 'text', 'IA', 6, 1);
    Block::setVal($secSvGridId, 'svc_icon', 'text', 'cpu', 6, 2);
    Block::setVal($secSvGridId, 'svc_points', 'textarea', "Chatbots & assistants | ML & automatisation | Plan de transformation", 6, 3);
    ...
    // Section 5.3 : Quick Contact Strip (bottom or top card strip)
    ...
    echo "\nAccès admin: /admin/login  (admin / password123)\n";
