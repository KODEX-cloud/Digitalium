<?php
/**
 * Safe Admin Account Recovery & Modification Tool
 * Designed for initial setup in production to modify default username/email/password.
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($newUsername) && !empty($newEmail) && !empty($newPassword)) {
        try {
            ...
            $message = "Vos identifiants administrateur ont été mis à jour avec succès ! Veuillez supprimer immédiatement ce fichier 'change_admin.php' de votre hébergement par mesure de sécurité.";
            $isSuccess = true;
        } catch (Exception $e) {
...
<body>
    <div class="card">
        ...
        <div class="subtitle">Modifiez le compte administrateur de votre CMS</div>
