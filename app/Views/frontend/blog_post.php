    ...
    <div class="container" style="max-width: 820px;">
        ...
        <div style="display: flex; align-items: center; gap: 20px; font-size: 0.85rem; color: var(--text-muted); padding-top: 20px; border-top: 1px solid var(--border);">
            ...
            <span style="display:inline-flex;gap:6px;flex-wrap:wrap;">
                ...
                <span style="background:rgba(99,102,241,0.1);border:1px solid rgba(99,102,241,0.2);color:var(--primary);padding:1px 9px;border-radius:50px;font-size:0.7rem;font-weight:700;"><?= htmlspecialchars($t['name']) ?></span>
                <?php endforeach; ?>
            </span>
            <?php endif; ?>
        </div>
...
<div style="background: var(--bg-base); padding: 0 20px 40px;">
    <div class="container" style="max-width: 820px;">
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
            ...
            <?php foreach ($postTags as $t): ?>
            <span style="background:rgba(99,102,241,0.07);border:1px solid rgba(99,102,241,0.18);color:var(--primary);padding:4px 12px;border-radius:50px;font-size:0.75rem;font-weight:700;">
        ...
        <div style="display:flex;flex-direction:column;gap:20px;margin-bottom:40px;">
            ...
            <div style="background:var(--bg-surface);border:1px solid var(--border);border-radius:14px;padding:20px;">
                <div style="display:flex;align-items:center;gap:12px;margin-bottom:10px;">
                    <div style="width:36px;height:36px;border-radius:50%;background:rgba(99,102,241,0.15);display:flex;align-items:center;justify-content:center;font-weight:700;color:var(--primary);font-size:0.9rem;">
...
.blog-content blockquote { border-left: 4px solid var(--primary); padding: 12px 24px; margin: 1.5rem 0; background: rgba(99,102,241,0.05); border-radius: 0 8px 8px 0; font-style: italic; color: var(--text-muted); }
.blog-content img { max-width: 100%; border-radius: 12px; margin: 1rem 0; }
.blog-content code { background: rgba(99,102,241,0.08); padding: 2px 8px; border-radius: 4px; font-size: 0.88em; font-family: monospace; }
