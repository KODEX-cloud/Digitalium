...
.tech-tag {
    display: inline-flex; padding: 3px 10px; background: rgba(99,102,241,0.06);
    border: 1px solid rgba(99,102,241,0.15); border-radius: 4px;
...
<section class="portfolio-hero">
    <div class="container">
        <div class="hero-tag reveal" style="display: inline-flex; align-items: center; gap: 8px; background: rgba(99,102,241,0.1); border: 1px solid rgba(99,102,241,0.25); padding: 0.35rem 1rem; border-radius: 50px; font-size: 0.68rem; letter-spacing: 0.2em; text-transform: uppercase; color: var(--accent); margin-bottom: 24px;">
