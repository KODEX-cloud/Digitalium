                    ...
                    <div class="team-card">
                        <div class="team-avatar-box">
                            <?php if (!empty($member['member_avatar'])): ?>
                                <img src="<?= htmlspecialchars(url($member['member_avatar'])) ?>" alt="<?= htmlspecialchars($member['member_name'] ?? 'Membre') ?>" loading="lazy">
                            <?php else: ?>
                            ...
                            <?php if (!empty($linkedin) || !empty($twitter) || !empty($github)): ?>
                                <div class="team-socials">
                                    <?php if (!empty($linkedin)): ?>
                                        <a href="<?= htmlspecialchars(url($linkedin)) ?>" class="team-social-link" target="_blank" aria-label="LinkedIn">
                                            <i data-lucide="linkedin" style="width: 18px; height: 18px;"></i>
                                        </a>
                                    <?php endif; ?>
                                    <?php if (!empty($twitter)): ?>
                                        <a href="<?= htmlspecialchars(url($twitter)) ?>" class="team-social-link" target="_blank" aria-label="Twitter">
                                            <i data-lucide="twitter" style="width: 18px; height: 18px;"></i>
                                        </a>
                                    <?php endif; ?>
                                    <?php if (!empty($github)): ?>
                                        <a href="<?= htmlspecialchars(url($github)) ?>" class="team-social-link" target="_blank" aria-label="GitHub">
            ...
            <?php else: ?>
                ...
                <div class="team-card">
                    ...
                    <div class="team-info">
                        ...
                        <div class="team-socials">
                            <a href="<?= htmlspecialchars($settings['social_linkedin'] ?? url('/contact')) ?>" class="team-social-link" target="_blank"><i data-lucide="linkedin" style="width: 18px; height: 18px;"></i></a>
                            <a href="<?= htmlspecialchars($settings['social_github'] ?? url('/contact')) ?>" class="team-social-link" target="_blank"><i data-lucide="github" style="width: 18px; height: 18px;"></i></a>
                        </div>
                    </div>
                </div>
                <div class="team-card">
