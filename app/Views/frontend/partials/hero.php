...
<style>
    ...
    .glass-stack-card:hover {
        ...
        box-shadow: 0 20px 40px color-mix(in srgb, var(--primary) 10%, transparent) !important;
    }
    .glass-feature-card:hover {
        transform: translateY(-5px) !important;
        border-color: color-mix(in srgb, var(--primary) 40%, transparent) !important;
        box-shadow: 0 20px 40px color-mix(in srgb, var(--primary) 15%, transparent) !important;
        ...
        <div class="slides-container" style="position: absolute; inset: 0; width: 100%; height: 100%;">
            <?php foreach ($slides as $idx => $slide): 
                $slideBg = !empty($slide['image']) 
                    ...
                    : (!empty($page['hero_bg_color']) ? "background: " . $page['hero_bg_color'] . ";" : "background: linear-gradient(135deg, #0b0f19 0%, var(--surface-dark) 100%);");
            ?>
                        ...
                        <div class="hero-grid" style="display: grid; <?= $gridOrder ?> gap: 60px; align-items: center; width: 100%;">
                            ...
                            <div class="hero-text-block" style="<?= $textOrder ?> max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?>">
                                <?php if (!empty($slide['badge'])): ?>
                                    <div class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--primary) 25%, transparent); border: 1px solid color-mix(in srgb, var(--primary) 40%, transparent); padding: 6px 18px; border-radius: 50px; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: #93c5fd; margin-bottom: 28px; font-family: var(--font-heading);">
                            ...
                            <div class="hero-right-visual" style="<?= $visualOrder ?> display: flex; justify-content: center; align-items: center;">
                                <div class="visual-wrap" style="position: relative; <?= $sizeStyle ?> max-width: <?= $visualMaxWidth ?>; filter: drop-shadow(0 25px 50px color-mix(in srgb, var(--primary) 25%, transparent));">
                                    <div class="mockup-frame" style="background: rgba(255, 255, 255, 0.15); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255, 255, 255, 0.2); padding: 12px; border-radius: 24px; box-shadow: inset 0 1px 1px rgba(255,255,255,0.4);">
                                        <div class="screen-frame" style="aspect-ratio: 1.5; background: var(--surface-dark); border-radius: 16px; overflow: hidden; border: 2px solid rgba(255,255,255,0.2); position: relative;">
                                            <?php if (!empty($slide['image'])): ?>
                                                <img src="<?= htmlspecialchars(url($slide['image'])) ?>" alt="Slide Visual" style="width: 100%; height: 100%; object-fit: cover; <?= $imageFilter ?>">
                                            <?php else: ?>
                                                <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #0b1329 0%, var(--surface-dark) 100%); display: flex; align-items: center; justify-content: center; color: white;">
    ...
    <section class="premium-hero hero-video-layout" id="hero-section-<?= $page['id'] ?>" style="position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>; background: #000;">
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%;">
            <div class="hero-text-block" style="max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?> opacity: 0; transform: translateY(20px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
                ...
                <?php if (!empty($badge)): ?>
                    <div class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--primary) 20%, transparent); border: 1px solid color-mix(in srgb, var(--primary) 30%, transparent); padding: 6px 18px; border-radius: 50px; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: #93c5fd; margin-bottom: 28px; font-family: var(--font-heading); box-shadow: 0 0 15px color-mix(in srgb, var(--primary) 15%, transparent);">
...
<?php elseif ($variant === 'hero_corporate'): ?>
    ...
    <section class="premium-hero hero-corporate-layout" id="hero-section-<?= $page['id'] ?>" style="position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>; background: linear-gradient(to right, var(--bg-base), var(--bg-alt));">
        
        <div class="hero-glow" style="position: absolute; top: 0; right: 0; width: 500px; height: 100%; background: radial-gradient(circle, color-mix(in srgb, var(--primary) 4%, transparent) 0%, transparent 80%); pointer-events: none;"></div>
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%;">
            <div class="hero-grid" style="display: grid; <?= $gridOrder ?> gap: 60px; align-items: center;">
                ...
                <div class="hero-text-block" style="<?= $textOrder ?> max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?>">
                    ...
                    <h1 style="font-size: clamp(2.4rem, 5vw, 3.8rem); line-height: 1.15; font-weight: 800; color: var(--surface-dark); margin-bottom: 20px; font-family: var(--font-heading); letter-spacing: -0.02em;">
                        <?= $page['hero_title'] ?>
                    </h1>
                ...
                <div class="hero-right-visual" style="<?= $visualOrder ?> display: flex; justify-content: center; align-items: center;">
                    <div style="width: 100%; max-width: 560px; position: relative;">
                        <div style="aspect-ratio: 1.4; border-radius: var(--radius-lg); overflow: hidden; background: var(--bg-base); box-shadow: 0 24px 48px rgba(15,23,42,0.14);">
    ...
    <section class="premium-hero hero-card-layout" id="hero-section-<?= $page['id'] ?>" style="position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>;">
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%; display: flex; justify-content: center;">
            ...
            <div class="floating-glass-card-hero" style="background: rgba(11,18,34,0.85); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); border: 1px solid rgba(255,255,255,0.1); padding: 48px 40px; border-radius: 24px; box-shadow: 0 30px 60px -15px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.06); max-width: 800px; width: 100%; text-align: center; display: flex; flex-direction: column; align-items: center; animation: floatBadge 8s ease-in-out infinite;">
                ...
                <?php if (!empty($badge)): ?>
                    <span class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--primary) 12%, transparent); border: 1px solid color-mix(in srgb, var(--primary) 25%, transparent); padding: 6px 18px; border-radius: 50px; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: var(--primary); margin-bottom: 24px; font-family: var(--font-heading);"><?= htmlspecialchars($badge) ?></span>
                <?php endif; ?>
                ...
                <div style="display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; align-items: center;">
                    ...
                    <?php endif; ?>
                    <?php if (!empty($page['hero_cta2_text'])): ?>
                        <a href="<?= htmlspecialchars(url($page['hero_cta2_url'] ?? '#services')) ?>" class="btn-cta-secondary" style="display: inline-flex; align-items: center; gap: 8px; padding: 14px 28px; border-radius: 12px; font-weight: 600; color: var(--surface-dark); background: rgba(15,23,42,0.04); border: 1px solid rgba(15,23,42,0.08); transition: var(--transition);">
                            <span><?= htmlspecialchars($page['hero_cta2_text']) ?></span>
                        </a>
                    <?php endif; ?>
                </div>
...
?>
    ...
    <section class="premium-hero hero-full-bg" id="hero-section-<?= $page['id'] ?>" style="position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>;">
        ...
        <div class="hero-glow-1" style="position: absolute; width: 600px; height: 600px; border-radius: 50%; background: radial-gradient(circle, color-mix(in srgb, var(--primary) 15%, transparent) 0%, color-mix(in srgb, var(--primary) 0%, transparent) 70%); top: -200px; right: -100px; z-index: 2; pointer-events: none;"></div>
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%;">
            <div class="hero-text-block" style="max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?> opacity: 0; transform: translateY(20px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
                ...
                <!-- Badge / Label -->
                <?php if (!empty($badge)): ?>
                    <div class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--primary) 12%, transparent); border: 1px solid color-mix(in srgb, var(--primary) 25%, transparent); padding: 6px 18px; border-radius: 50px; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: #93c5fd; margin-bottom: 28px; font-family: var(--font-heading); box-shadow: 0 0 15px color-mix(in srgb, var(--primary) 10%, transparent);">
                        <div style="width: 6px; height: 6px; border-radius: 50%; background: #60a5fa; box-shadow: 0 0 8px #60a5fa;"></div>
                        <span><?= htmlspecialchars($badge) ?></span>
                    </div>
                <?php endif; ?>
...
<?php elseif ($variant === 'hero_text_only'): ?>
    ...
    <section class="premium-hero hero-text-only-layout" id="hero-section-<?= $page['id'] ?>" style="<?= $bgStyle ?> position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>;">
        ...
        <div class="hero-glow-1" style="position: absolute; width: 500px; height: 500px; border-radius: 50%; background: radial-gradient(circle, color-mix(in srgb, var(--secondary) 8%, transparent) 0%, color-mix(in srgb, var(--secondary) 0%, transparent) 70%); top: -100px; right: -50px; z-index: 1; pointer-events: none;"></div>
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%;">
            <div class="hero-text-block" style="max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?> opacity: 0; transform: translateY(20px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
                ...
                <!-- Badge -->
                <?php if (!empty($badge)): ?>
                    <div class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--secondary) 8%, transparent); border: 1px solid color-mix(in srgb, var(--secondary) 20%, transparent); padding: 6px 16px; border-radius: 50px; font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.12em; color: var(--secondary); margin-bottom: 24px; font-family: var(--font-heading);">
...
<?php elseif ($variant === 'hero_split_asymmetric'): ?>
    ...
    <section class="premium-hero hero-asymmetric-layout" id="hero-section-<?= $page['id'] ?>" style="<?= $bgStyle ?> position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>;">
        ...
        <div class="hero-glow-1" style="position: absolute; width: 600px; height: 600px; border-radius: 50%; background: radial-gradient(circle, color-mix(in srgb, var(--secondary) 12%, transparent) 0%, color-mix(in srgb, var(--secondary) 0%, transparent) 70%); top: -100px; right: -50px; z-index: 1; pointer-events: none;"></div>
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%;">
            <div class="hero-grid" style="display: grid; <?= $gridOrder ?> gap: 60px; align-items: center;">
                ...
                <div class="hero-left-content hero-text-block" style="<?= $textOrder ?> max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?> opacity: 0; transform: translateY(20px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
                    ...
                    <?php if (!empty($badge)): ?>
                        <div class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--secondary) 8%, transparent); border: 1px solid color-mix(in srgb, var(--secondary) 20%, transparent); padding: 6px 16px; border-radius: 50px; font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.15em; color: var(--secondary); margin-bottom: 24px; font-family: var(--font-heading);">
                            <div style="width: 6px; height: 6px; border-radius: 50%; background: var(--secondary); box-shadow: 0 0 8px var(--secondary);"></div>
                            <span><?= htmlspecialchars($badge) ?></span>
                        </div>
                    <?php endif; ?>
                ...
                if (empty($heroFeatures)) {
                    $heroFeatures = [
                        ['icon' => 'zap', 'title' => htmlspecialchars($settings['site_name'] ?? 'Digitalium'), 'desc' => 'Solutions digitales haute performance.', 'color' => 'color-mix(in srgb, var(--primary) 10%, transparent)', 'iconColor' => 'var(--primary)', 'offset' => '-15px'],
                        ['icon' => 'shield-check', 'title' => 'Sécurité & Fiabilité', 'desc' => 'Protection de vos données et transactions.', 'color' => 'color-mix(in srgb, var(--secondary) 10%, transparent)', 'iconColor' => 'var(--secondary)', 'offset' => '0'],
                ...
                <div class="hero-right-visual" style="<?= $visualOrder ?> position: relative; opacity: 0; transform: scale(0.95) translateY(10px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) 0.2s forwards; display: flex; justify-content: center; align-items: center;">
                    <div class="asymmetric-card-stack" style="display: flex; flex-direction: column; gap: 20px; width: 100%; max-width: 440px;">
                        <?php foreach (array_slice($heroFeatures, 0, 3) as $fi => $feat):
                            ...
                            $isBordered = $fi === 1;
                        ?>
                        <div class="glass-stack-card" style="background: rgba(255,255,255,<?= $isBordered ? '0.7' : '0.65' ?>); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,<?= $isBordered ? '0.8' : '0.7' ?>); <?= $isBordered ? 'border-left: 4px solid var(--secondary);' : '' ?> border-radius: 16px; padding: 18px 24px; box-shadow: <?= $isBordered ? '0 20px 40px color-mix(in srgb, var(--primary) 6%, transparent)' : '0 10px 30px rgba(0,0,0,0.05)' ?>; display: flex; align-items: center; gap: 16px; transform: <?= $isBordered ? 'scale(1.03)' : "translateX($offset)" ?>; transition: all 0.4s ease-in-out;">
                            <div style="width: 42px; height: 42px; border-radius: 12px; background: <?= htmlspecialchars($feat['color'] ?? 'color-mix(in srgb, var(--primary) 10%, transparent)') ?>; display: flex; align-items: center; justify-content: center; color: <?= htmlspecialchars($feat['iconColor'] ?? 'var(--primary)') ?>;">
...
<?php elseif ($variant === 'hero_grid_features'): ?>
    ...
    <section class="premium-hero hero-grid-features-layout" id="hero-section-<?= $page['id'] ?>" style="<?= $bgStyle ?> position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>;">
        ...
        <div class="hero-glow-1" style="position: absolute; width: 600px; height: 600px; border-radius: 50%; background: radial-gradient(circle, color-mix(in srgb, var(--primary) 10%, transparent) 0%, color-mix(in srgb, var(--primary) 0%, transparent) 70%); top: -100px; right: -50px; z-index: 1; pointer-events: none;"></div>
        ...
        <div class="container" style="position: relative; z-index: 5; width: 100%;">
            <div class="hero-grid" style="display: grid; <?= $gridOrder ?> gap: 60px; align-items: center;">
                ...
                <div class="hero-left-content hero-text-block" style="<?= $textOrder ?> max-width: <?= $heroTextWidth ?>; <?= $textMarginCss ?> <?= $textAlignmentCss ?> display: flex; flex-direction: column; <?= ($heroTextAlignment === 'center' || $heroTextAlignment === 'centre') ? 'align-items: center;' : (($heroTextAlignment === 'right' || $heroTextAlignment === 'droite') ? 'align-items: flex-end;' : 'align-items: flex-start;') ?> opacity: 0; transform: translateY(20px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
                    ...
                    <?php if (!empty($badge)): ?>
                        <div class="hero-brand-badge" style="display: inline-flex; align-items: center; gap: 8px; background: color-mix(in srgb, var(--primary) 8%, transparent); border: 1px solid color-mix(in srgb, var(--primary) 20%, transparent); padding: 6px 16px; border-radius: 50px; font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.15em; color: var(--primary); margin-bottom: 24px; font-family: var(--font-heading);">
                ...
                if (empty($gridFeats)) {
                    $gridFeats = [
                        ['icon' => 'cpu', 'title' => 'IA & Automation', 'desc' => 'Optimisez vos process métiers.', 'color' => 'color-mix(in srgb, var(--primary) 10%, transparent)', 'iconColor' => 'var(--primary)'],
                        ['icon' => 'cloud', 'title' => 'Infrastructure Cloud', 'desc' => 'Hébergement sécurisé scalable.', 'color' => 'color-mix(in srgb, var(--secondary) 10%, transparent)', 'iconColor' => 'var(--secondary)'],
                ...
                <div class="hero-right-visual" style="<?= $visualOrder ?> position: relative; opacity: 0; transform: scale(0.95) translateY(10px); animation: heroFadeIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) 0.2s forwards; display: flex; justify-content: center; align-items: center;">
                    <div class="grid-features-wrap" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; width: 100%; max-width: 440px;">
                        ...
                        <div class="glass-feature-card" style="background: rgba(255,255,255,0.04); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; padding: 24px 20px; box-shadow: 0 0 0 1px rgba(255,255,255,0.04), 0 10px 30px rgba(0,0,0,0.25); display: flex; flex-direction: column; gap: 14px; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1);">
                            <div style="width: 38px; height: 38px; border-radius: 10px; background: <?= htmlspecialchars($gf['color'] ?? 'color-mix(in srgb, var(--primary) 10%, transparent)') ?>; display: flex; align-items: center; justify-content: center; color: <?= htmlspecialchars($gf['iconColor'] ?? 'var(--primary)') ?>;">
...
?>
    ...
    <section class="premium-hero hero-split-layout" id="hero-section-<?= $page['id'] ?>" style="<?= $bgStyle ?> position: relative; padding: <?= $heroPadding ?>; overflow: hidden; display: flex; <?= $verticalAlignCss ?> min-height: <?= $heroMinHeight ?>;">
        ...
        <!-- Ambient Glows -->
        <div class="hero-glow-1" style="position: absolute; width: 500px; height: 500px; border-radius: 50%; background: radial-gradient(circle, color-mix(in srgb, var(--secondary) 12%, transparent) 0%, color-mix(in srgb, var(--secondary) 0%, transparent) 70%); top: -100px; right: -50px; z-index: 1; pointer-events: none;"></div>
                    ...
                    <div class="visual-wrap" style="position: relative; <?= $sizeStyle ?> max-width: <?= $visualMaxWidth ?>; filter: drop-shadow(0 25px 50px rgba(30, 58, 138, 0.15));">
                        ...
                        <?php if ($isFloating): ?>
                            ...
                            <div class="floating-glass-card" style="background: rgba(30, 41, 59, 0.45); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.12); padding: 16px; border-radius: 24px; box-shadow: 0 30px 60px rgba(0,0,0,0.3); animation: floatBadge 8s ease-in-out infinite; overflow: hidden; position: relative;">
                                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(135deg, color-mix(in srgb, var(--primary) 8%, transparent) 0%, transparent 100%); pointer-events: none;"></div>
                                <div class="card-screen" style="aspect-ratio: 1.4; border-radius: 16px; overflow: hidden; border: 1px solid rgba(255,255,255,0.15); position: relative;">
                                    ...
                                    <?php else: ?>
                                        <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #0b1329 0%, var(--surface-dark) 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; color: white; padding: 20px; text-align: center;">
                        ...
                        <?php else: ?>
                            ...
                            <div class="mockup-frame" style="background: rgba(11,18,34,0.8); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.08); padding: 12px; border-radius: 24px; box-shadow: 0 0 0 1px rgba(255,255,255,0.04), 0 25px 50px rgba(0,0,0,0.4);">
                                <div class="screen-frame" style="aspect-ratio: 1.5; background: var(--surface-dark); border-radius: 16px; overflow: hidden; border: 2px solid #334155; position: relative;">
                                    <?php if (!empty($page['hero_image'])): ?>
                                        <picture>
                                            <?php if (!empty($heroImageMobile)): ?>
                                                <source srcset="<?= htmlspecialchars(url($heroImageMobile)) ?>" media="(max-width: 768px)">
                                    ...
                                    <?php else: ?>
                                        <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #0b1329 0%, var(--surface-dark) 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; color: white; padding: 20px; text-align: center;">
                                            <div style="width: 60px; height: 60px; border-radius: 50%; background: rgba(255,255,255,0.06); display: flex; align-items: center; justify-content: center; box-shadow: 0 0 20px color-mix(in srgb, var(--primary) 10%, transparent);">
                                                <i data-lucide="cpu" style="width: 28px; height: 28px; color: var(--accent);"></i>
                                            </div>
...
.btn-cta-primary:hover {
    ...
    box-shadow: 0 15px 30px -5px color-mix(in srgb, var(--primary) 60%, transparent) !important;
}
